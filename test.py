...
DATA_URL = (
    "D:\pycharm\Motor_Vehicle_Collisions_-_Crashes.csv"
)
...
st.markdown("Vehicle collisions between {}:00 and {}:00".format(hour, hour + 1))
...
st.subheader("Breakdown by minute between {}:00 and {}:00".format(hour, hour + 1))
filtered = data[
